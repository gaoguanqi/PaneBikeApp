...
import net.hyntech.common.widget.imgloader.BaseImageLoaderStrategy
import net.hyntech.common.widget.imgloader.TransType
import net.hyntech.common.widget.imgloader.http.ProgressInterceptor
        ...
        Glide.with(ctx)
            ...
            .into(object : DrawableImageViewTarget(config.imageView) {
                override fun onLoadStarted(placeholder: Drawable?) {
                    ...
                    config.imageView.setImageResource(R.color.common_color_progress)
                }
