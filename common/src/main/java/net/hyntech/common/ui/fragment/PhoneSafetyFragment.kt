...
import net.hyntech.common.databinding.FragmentPhoneSafetyBinding
import net.hyntech.common.ui.activity.AccountSafetyActivity
import net.hyntech.common.vm.AccountSafetyViewModel

class PhoneSafetyFragment:BaseFragment<FragmentPhoneSafetyBinding, AccountSafetyViewModel>() {
    ...
    override fun getLayoutId(): Int = R.layout.fragment_phone_safety
    ...
    override fun initData(savedInstanceState: Bundle?) {
        view?.apply {
            ...
            tvTitle?.text = UIUtils.getString(R.string.common_title_phone_safety)
