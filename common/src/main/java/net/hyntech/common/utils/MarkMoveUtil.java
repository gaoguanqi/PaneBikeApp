...
public class MarkMoveUtil {
     ...
     * @param mMapView
     */
    public MarkMoveUtil( Context context,TextureMapView mMapView, Marker marker,List<LatLng> list
    ) {
        this.latlngs = list;
        this.sl0 = latlngs.get(0).longitude;
        this.slt = latlngs.get(0).latitude;
        this.param = 6.0;
